...
theorem step_deterministic {t t' t'' : Term} (H1 : t -> t') (H2 : t -> t'')
  : t' = t'' := by
...
| step (t t' : Term) (h : t -> t') : MultiStep t t'
| trans (t t' t'' : Term) (h₁ : MultiStep t t') (h₂ : MultiStep t' t'') : MultiStep t t''
...
theorem uniqueness_of_normal_forms {t u u' : Term}
  (H : t ->* u)
  (H' : t ->* u')
  (Hn : NormalForm u)
  (Hn' : NormalForm u') :
